...
public class MainServiceImpl implements MainService {
	...
	public int resetPw(HttpServletRequest request) throws Exception {
        ...
        // 받는 사람 이메일 설정
        mail.setToEmail(CepStringUtil.nullToString(request.getParameter("email")));
        // 메일 제목 설정
        ...
        mail.setContent(String.join(
                ...
                "<p><label>"+CepStringUtil.nullToString(request.getParameter("email"))+"</label>님, <br>회원님의 CEP 계정 비밀번호를 안내합니다.</p>",
