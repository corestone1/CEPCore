...
@Alias("mngMaintOrderVO")
public class MngMaintOrderVO implements Serializable {
	...
	private List<MngMaintOrderVO> list;
	...
	public List<MngMaintOrderVO> getList() {
		return list;
	}
	public void setList(List<MngMaintOrderVO> list) {
		this.list = list;
	}
}
