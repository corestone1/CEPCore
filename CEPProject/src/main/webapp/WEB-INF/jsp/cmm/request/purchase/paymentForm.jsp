...
<body>
	<div class="stitle">
		<ul id="infoList">
			<li><a class="on" id="A_TOPMenu_FORM" title="/cmm/request/purchase/paymentForm.do">지급정보</a></li>
			<li><a id="A_TOPMenu_PAY" title="/cmm/request/purchase/prePaymentList.do">기지급정보</a></li>
			<li></li>
		</ul>
	</div>
	<div class="floatC">
