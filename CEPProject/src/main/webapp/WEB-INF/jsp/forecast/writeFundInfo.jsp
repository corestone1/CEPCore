...
<body>
	<div class="popContainer">
		...
		<div class="left">
			<ul class="ftw300">
				<li class="colorWhite cursorP" onclick="javascript:fn_addView('writeBasic')">기본 정보</li>
		...
		<div class="contents">
			<div>
				<table>
					<tr>
						<td><input type="text" placeholder="매출액" /></td>
					</tr>
					<tr>
						<td><input type="text" placeholder="매입액" /></td>
					</tr>
					<tr>
						<td>
							<span>매출일정</span>
					...
					<tr>
						<td><input type="text" placeholder="매입처" class="search" /></td>
					</tr>
					<tr>
						<td>
							<span>매입일정</span>
			...
			<div class="btnWrap">
				<button onclick="javascript:fn_addView('writeBasic')"><img src="<c:url value='/images/btn_prev.png'/>" /></button>
				<button onclick="javascript:fn_addView('writeProgress')"><img src="<c:url value='/images/btn_next.png'/>" /></button>
			</div>
		</div>
	</div>
</body>
