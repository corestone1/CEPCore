...
<body>
	<div class="popContainer">
		...
		<div class="contents">
			...
			<div class="btnWrap">
				<button onclick="javascript:fn_addView('writeFundInfo')"><img src="<c:url value='/images/btn_prev.png'/>" /></button>
				<button onclick="javascript:fn_addView('forecastList')"><img src="<c:url value='/images/btn_next.png'/>" /></button>
			</div>
		</div>
	</div>
</body>
