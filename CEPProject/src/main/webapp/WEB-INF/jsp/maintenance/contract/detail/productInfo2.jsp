							...
							<c:forEach var="list" items="${productList}" varStatus="status">
								<tr>
									<td onclick="event.cancelBubble = true;">
										<input type="radio" class="tRadio" name="m_gubun" id="check<c:out value="${status.count}"/>" value="<c:out value="${list.mtSalesPmKey}"/>" /><label for="check<c:out value="${status.count}"/>" class="cursorP"/>
									</td>
