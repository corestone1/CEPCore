		...
		<div class="contentsWrap">
			<div class="contents mgauto">
				...
				<div class="floatR dpBlock fxd">
					<div class="title">
						<ul>
							<li id="LI_TOPBar_WB" class="on" title="/maintenance/detail/mtWorkBasicInfo.do"><label style="cursor: pointer;">작업정보</label></li>
							<li id="LI_TOPBar_WO" title="/maintenance/detail/mtWorkBasicInfo.do"><label id="orderLabel">발주정보</label></li>
							<li></li>
						</ul>
					</div>
					<div id="detailForm">
						...
						<div class="floatC">
							...
							<table class="dtl" id="modTable" style="display:none">
								<tr>
									<td>고객담당자</td>
									<td>
								...
								<tr>
									<td>지원내용</td>
									<td>
										<textarea name="mtWorkCont" style="height: 72px"></textarea>
									</td>
								</tr>
								<tr>
									<td>비고</td>
									<td>
										<textarea name="remark" style="height: 49px"></textarea>
									</td>
								</tr>
							</table>
						</div>
