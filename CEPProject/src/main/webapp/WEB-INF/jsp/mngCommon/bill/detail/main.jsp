...
<head>
	...
	<script>
		$(document).ready(function() {
			...
			var newUrl = "/mngCommon/bill/detail/billForm.do?pjKey=${basicInfo.pjKey}&acKey=${basicInfo.acKey}";
							...
							<form>
								<table class="bsc" id="selectBasicTable">
									...
									<tr>
										<td>기간</td>
										<td>
											<label><c:out value="${displayUtil.displayDate(basicInfo.pjStartDt)}"/></label>
											<label> ~ <c:out value="${displayUtil.displayDate(basicInfo.pjEndDt)}"/></label>
										</td>
									</tr>
									<tr>
										<td>수금계획</td>
										<td>
											<label><c:out value="${basicInfo.collectTurn}"/> 회</label>
