				...
				<div>
					<table  style="width: 651px;">
						...
						<tr>
							...
							<td class="tdContents">
								<input type="text"   id="m_ipt_pjNm"  value="${billingOpInfo.pjNm}" onclick="javascript:fnOpenPjPopup();" class="search" style="width: 315px; background-color: #d3d3d3;" readOnly/>
								<input type="hidden" id="m_ipt_pjKey" name="pjKey"  value="${billingOpInfo.pjKey}"/>
						...
						<tr id="m_tr_account" >
							...
							<td id="m_td_account" class="tdContents">
								<input type="text"   id="m_ipt_acNm"  value="${billingOpInfo.acNm}" style="width: 315px; background-color: #d3d3d3;" disabled/>
								<input type="hidden" id="m_ipt_acKey" value="${billingOpInfo.acKey}"/>
							</td>
						</tr>
						<tr id="m_tr_account" >
							<td class="tdTitle">매출처 / 사업자번호</td>
							<td id="m_td_account" class="tdContents">
								<input type="text"   id="m_ipt_billAcNm" value="${billingOpInfo.billAcNm}"/>
								&nbsp;/&nbsp;
								<input type="text"   id="m_ipt_billAcKey" value="${billingOpInfo.billAcKey}"/> 
							</td>
						</tr>
						<tr id="m_tr_account" >
							<td class="tdTitle">매출처 담당자 / 발행 이메일</td>
							<td id="m_td_account" class="tdContents">
								<input type="text"   id="m_ipt_billAcDirectorName"  value="${billingOpInfo.billAcDirectorName}"/>
								&nbsp;/&nbsp;
								<input type="text"   id="m_ipt_billIssueEmail"  value="${billingOpInfo.billIssueEmail}"/> 
							</td>
						</tr>
						<tr id="m_tr_account" >
							<td class="tdTitle">계산서 금액</td>
							<td id="m_td_account" class="tdContents">
								<input type="text"   id="m_ipt_billAmount" value="${billingOpInfo.billAmount}"/>
							</td>
						</tr>
						<tr id="m_tr_account" >
							<td class="tdTitle">진행상태</td>
							<td id="m_td_account" class="tdContents">
								<input type="text"   id="m_ipt_billIssueStatus" value="${billingOpInfo.billIssueStatus}"/>
							</td>
						</tr>
						<tr id="m_tr_account" >
							<td class="tdTitle">수금완료일자</td>
							<td id="m_td_account" class="tdContents">
								<input type="text"   id="m_ipt_salesCollectFinishDt" value="${billingOpInfo.salesCollectFinishDt}"/>
							</td>
						</tr>
						<tr id="m_tr_account" >
							<td class="tdTitle">계산서 번호</td>
							<td class="tdContents">
								<input type="text" id="m_ipt_billNo" name="billNo" class="" value="${billingOpInfo.billNo}" /> 
							</td>
						</tr>
						<tr>
