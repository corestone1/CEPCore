      ...
      function fn_addInfoTable2() {
          ...
          $('#'+type+'Length').val($('#'+type+'Length').val()*1 + 1);
           ...
           for(var i = 0; i < nameArr.length; i++) {
             ...
             clone.find('input[name="'+ type + 'List[' + originLength + '].' + splitName+'"]').attr('name', name + splitName).val("");
             clone.find('textarea[name="'+ type + 'List[' + originLength + '].' + splitName+'"]').attr('name', name + splitName).val(""); 
             /* clone.find('input:radio[name="'+ type + 'List[' + originLength + '].' + splitName+'"]').attr('id', name + splitName).val(""); */   
             clone.find('select[name="'+ type + 'List[' + originLength + '].' + splitName+'"]').attr('name', name + splitName);
           } 
         ...
         <div class="contents2">
            ...
            <div class="btnWrap floatR">
               <div class="floatR" onclick="fn_preBiddingView();">
                  <button type="button" onclick="example();"><img src="<c:url value='/images/btn_bill_mapping.png'/>"/></button>
               </div>
