...
<head>
    ...
    <c:set var="registerFlag" value="${empty sampleVO.title ? 'create' : 'modify'}"/>
    ...
    <div id="content_pop">
    	...
    	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		...
    		<c:if test="${registerFlag == 'modify'}">
        		<tr>
        			<td class="tbtd_caption"><label for="seq">번호</label></td>
	    			<td class="tbtd_content">
	    				<form:input path="seq" maxlength="30" cssClass="txt" />
    		...
    		<tr>
    			...
    			<td class="tbtd_content">
    				<form:input path="content" maxlength="30" cssClass="txt"/>
    				&nbsp;<form:errors path="content" />
    			</td>
    		</tr>
    		<tr>
    			<td class="tbtd_caption"><label for="userName">사용자이름</label></td>
    			<td class="tbtd_content">
    				<form:input path="userName" maxlength="30" cssClass="txt"/>
    				&nbsp;<form:errors path="userName" />
    			</td>
    		</tr>
    		<tr>
    			<td class="tbtd_caption"><label for="userId">사용자Id</label></td>
    			<td class="tbtd_content">
